...
/* copied this stuff from slashthem because it un-kludged my stuff?*/
#ifdef DUMP_LOG
...
#define PN_PROTECTION_SPELL	(-12)
#define PN_BODY_SPELL		(-13)
#define PN_MATTER_SPELL		(-14)
#define PN_MUSICALIZE		(-15)
#define PN_BARE_HANDED		(-16)
#define PN_MARTIAL_ARTS		(-17)
#define PN_RIDING		(-18)
#define PN_TWO_WEAPONS		(-19)
#ifdef LIGHTSABERS
#define PN_LIGHTSABER		(-20)
#endif
...
STATIC_OVL NEARDATA const short skill_names_indices[P_NUM_SKILLS] = {
	...
	SHURIKEN,         PN_BOOMERANG,      PN_WHIP,      UNICORN_HORN,
#ifdef LIGHTSABERS
	PN_LIGHTSABER,
#endif
...
static const NEARDATA short hwep[] = {
	  ...
	  KATANA, UNICORN_HORN, CRYSKNIFE, TRIDENT, LONG_SWORD , ELECTRIC_SWORD,
	  ...
	  ORCISH_DAGGER,
	  ATHAME, SCALPEL, KNIFE, TORCH, GUITAR, WORM_TOOTH
};
...
const struct def_skill *class_skill;
{
    ...
    } else if (Role_if(PM_FLAME_MAGE) || Role_if(PM_ICE_MAGE) || Role_if(PM_AETHERIC_MAGE) || Role_if(PM_METAL_MAGE)/* || Role_if(PM_EARTH_MAGE)*/)  {

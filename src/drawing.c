...
const char * const monexplain[MAXMCLASSES] = {
    ...
    "piece of food",	"pile of coins",	"grue",		"wall monster",
...
/*20*/	{'.', "floor of a room",C(CLR_GRAY)},	/* room */
	...
	{'_', "altar",		C(HI_SILVER)},	/* altar */
	{'|', "grave",      C(CLR_GRAY)},   /* grave */
	{'\\', "opulent throne",C(HI_GOLD)},	/* throne */
#ifdef SINKS
/*30*/	{'#', "sink",		C(DRAGON_SILVER)},	/* sink */
	{'#', "toilet",         C(HI_GOLD)},  /* toilet */
#else
/*30*/	{'#', "",		C(HI_SILVER)},	/* sink */
	{'\\', "",              C(HI_GOLD)},  /* toilet */
#endif
...
/*30*/	g_FILLER(S_sink),
	...
	g_FILLER(S_air),
/*40*/	g_FILLER(S_cloud),
	0xfa,	/* S_puddle:	meta-z, centered dot */
...
/*30*/	g_FILLER(S_sink),
	...
	g_FILLER(S_air),
/*40*/	g_FILLER(S_cloud),
	0xfe,	/* S_puddle:	meta-~, centered dot */

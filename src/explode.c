...
/*WAC add light source for fire*/
	...
	for(i = 0; i < area->nlocations; i++) {
		...
		/* blessed scrolls of fire don't harm the reader (I hope this works and might also work for 
		new scroll types ice ball/lightning ball/etc)*/
		if (obj && obj->oclass == SCROLL_CLASS && obj->blessed)
		    explmask[1][1] = 2;/* description to here was added*/

...
{
	switch (Role_switch) {
		/* WAC 'F' and 'I' get bonus similar to 'W' Also Aetheric, Earth, and Metal*/
...
/* STEPHEN WHITE'S NEW CODE */                
		...
		switch (Role_switch) {
			...
			case PM_AETHERIC_MAGE: u.uenbase += rnd(6) + 2; break;
			case PM_BARBARIAN: u.uenbase += rnd(2); break;
			case PM_BARD: u.uenbase += rnd(5) + 1; break;
			...
			case PM_EXPLORATOR: u.uenbase += rnd(4) + 1; break;
			case PM_EARTH_MAGE: u.uenbase += rnd(6) + 2; break;
			case PM_FIGHTER: u.uenbase += rnd(2); break;
			case PM_FLAME_MAGE: u.uenbase += rnd(6) + 2; break;
			case PM_GNOME: u.uenbase += rnd(3); break;
			case PM_HEALER: u.uenbase += rnd(6) + 2; break;
			case PM_INSTRUMENTALIST: u.uenbase += rnd(5) + 1; break;
			...
			case PM_METAL_MAGE: u.uenbase += rnd(6) + 2; break;
			...
			case PM_VEELA: u.uenbase += rnd(3); break;

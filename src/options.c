...
# endif
	...
	{"ozslash_start_text",    &iflags.ozslash_start_text, TRUE, DISP_IN_GAME},
#ifdef ASCIIGRAPH
...
static struct Comp_Opt
{
	...
	{ "menu_select_page", "select all items on this page of a menu",
						4, SET_IN_FILE },
	{ "monkeyname",  "the name of your (first) monkey (e.g., monkeyname:Monkiee)",
						PL_PSIZ, DISP_IN_GAME },
	{ "monsters", "the symbols to use for monsters",
						MAXMCLASSES, SET_IN_FILE },
	{ "msghistory", "number of top line messages to save",
						5, DISP_IN_GAME },
	{ "parrotname",  "the name of your (first) parrot (e.g., parrotname:Yarr)",
						PL_PSIZ, DISP_IN_GAME },
# ifdef TTY_GRAPHICS
...
#endif
	{ "startquestions", "order in which the new game questions are asked",
				NUM_STARTQ, DISP_IN_GAME },
...
char *buf;
{
	...
	else if (!strcmp(optname, "startquestions"))
		Sprintf(buf, "%s", startq_order);

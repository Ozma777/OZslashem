...
/* "an uncursed greased partly eaten ravenous bugblatter beast of traal corpse" */
...
STATIC_OVL struct Jitem Pirate_items[] = {
    { POT_BOOZE, "ye olde spiced rum" },
	{ CRAM_RATION, "sea biscuit" },
	{ SCIMITAR, "cutlass" },
    { SACK, "woven cloth bag" },
...
register struct obj *obj;
{
	...
	char prefix[PREFIX];
	char tmpbuf[PREFIX+1],tmpbuf2[PREFIX+1];
...
STATIC_OVL NEARDATA const struct o_range o_ranges[] = {
	{ "bag",	TOOL_CLASS,   SACK,	      TRICK_BAG },
	{ "lamp",	TOOL_CLASS,   OIL_LAMP,	      MAGIC_LAMP },
	{ "candle",     TOOL_CLASS,   TALLOW_CANDLE,  MAGIC_CANDLE },
	{ "horn",	TOOL_CLASS,   TOOLED_HORN,    HORN_OF_PLENTY },
	{ "shield",	ARMOR_CLASS,  SMALL_SHIELD,   SHIELD_OF_REFLECTION },
	{ "helm",	ARMOR_CLASS,  ELVEN_LEATHER_HELM, HELM_OF_TELEPATHY },
	{ "gloves",	ARMOR_CLASS,  LEATHER_GLOVES, GAUNTLETS_OF_REFLECTION },
	{ "gauntlets",	ARMOR_CLASS,  LEATHER_GLOVES, GAUNTLETS_OF_REFLECTION },
...
#endif
#ifdef PIRATE
	{ "pirate shirt",	ARMOR_CLASS, PIRATE_SHIRT
	 },
#endif
	{ "dragon scales",
...
# endif
		...
		if(!BSTRCMP(bp, p-6, "column")) {
		    levl[u.ux][u.uy].typ = COLUMN;
		    pline("A column.");
		    newsym(u.ux, u.uy);

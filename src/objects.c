...
WEAPON("orcish dagger", "crude dagger",
	0, 1, 0, 7, 10,  4,  3,  3, 2, P,   P_DAGGER, IRON, CLR_BLACK),
WEAPON("dagger", (char *)0,
	1, 1, 0, 15, 10,  4,  4,  3, 2, P,   P_DAGGER, IRON, HI_METAL),
WEAPON("athame", (char *)0,
	1, 1, 0,  2, 10,  4,  4,  3, 2, S,   P_DAGGER, IRON, HI_METAL),
WEAPON("silver dagger", (char *)0,
	1, 1, 0,  4, 12, 40,  4,  3, 2, P,   P_DAGGER, SILVER, HI_SILVER),
...
WEAPON("elven dagger", "runed dagger",
	0, 1, 0,  6, 10,  4,  5,  3, 2, P,   P_DAGGER, WOOD, HI_METAL),
...
WEAPON("knife", (char *)0,
	1, 1, 0, 12,  5,  4,  3,  2, 0, P|S, P_KNIFE, IRON, HI_METAL),
WEAPON("silver knife", (char *)0,
	1, 1, 0, 3,  5,  4,  3,  2, 0, P|S, P_KNIFE, IRON, HI_SILVER),
...
WEAPON("broadsword", (char *)0,
	1, 0, 0, 19, 70, 10,  4,  6, 0, S,   P_BROAD_SWORD, IRON, HI_METAL),
						/* +d4 small, +1 large */
...
WEAPON("insect squasher", (char *)0,
	1, 0, 0,  0, 4, 0, 30,  2, 4, B,   P_PADDLE, PLASTIC, CLR_GREEN),
...
/* Quarterstaves */
WEAPON("bamboo pole", "staff",
	0, 0, 1, 11, 10,  1,  6,  3, 0, B,   P_QUARTERSTAFF, WOOD, HI_WOOD),
...
PROJECTILE("crossbow bolt", (char *)0,
	1, 42, 1, 2, 4, 6, 0, IRON, -P_CROSSBOW, HI_METAL),
...
/* Boomerangs */
WEAPON("wooden boomerang", "boomerang",
	0, 1, 0, 15,  5, 20,  9,  9, 0, 0,   -P_BOOMERANG, WOOD, HI_WOOD),
	/* this worked when wished for but I changed it to slashem extended (silver)
OBJECT(OBJ("magic boomerang","boomerang"),
       BITS(0,1,1,0,1,1,0,0,0,0,0,-P_BOOMERANG, WOOD), 0,
       WEAPON_CLASS, 0, 0, 5, 80, 9,9,0,0,5, HI_WOOD),*/
WEAPON("magic boomerang", "silver circular blade",
	1, 1, 0,  1,  0, 20,  9,  9, 0, 0,   -P_BOOMERANG, SILVER, CLR_BRIGHT_CYAN),
...
WEAPON("rubber hose", (char *)0,
	1, 0, 0,  0, 20,  3,  4,  3, 0, B,   P_WHIP, PLASTIC, CLR_BRIGHT_GREEN),
#endif
...
ARMOR("Hawaiian shirt", (char *)0,
	1, 0, 0, 0,	 6, 0,	 5,   3, 10, 0, ARM_SHIRT, CLOTH, CLR_MAGENTA),
ARMOR("T-shirt", (char *)0,
	1, 0, 0, 0,	 2, 0,	 5,   2, 10, 0, ARM_SHIRT, CLOTH, CLR_WHITE),
#endif
#ifdef PIRATE
ARMOR("pirate shirt", (char *)0,
	1, 0, 0, 0,	 2, 0,	 5,   2, 10, 0, ARM_SHIRT, CLOTH, CLR_BRIGHT_CYAN),	
#endif
#ifdef CONVICT
...
ARMOR("expensive suit", "expensive clothes",
	0, 0, 1, 0,	0, 5, 4, 1000,  8, 1, ARM_SUIT, CLOTH, CLR_BLACK),
...
DRGN_ARMR("stone dragon scale mail",  1, STONE_RES, 1200, 1, CLR_BLACK),
...
DRGN_ARMR("stone dragon scales",  0, STONE_RES, 700, 7, CLR_BLACK),
...
HELM("helm of opposite alignment", "crested helmet",
		0, 1, 0,			6, 1, 50,  50, 9, 0, IRON, CLR_RED),
HELM("helm of telepathy", "visored helmet",
		0, 1, TELEPAT,		2, 1, 50,  50, 9, 0, IRON, CLR_YELLOW),
...
GLOVES("gauntlets of fumbling", "padded gloves",
		0, 1,  FUMBLING,	6, 1, 10, 50,  9, 0, LEATHER, CLR_WHITE),
GLOVES("gauntlets of power", "riding gloves",
		0, 1,  0,			6, 1, 30, 50,  9, 0, IRON, CLR_BROWN),
GLOVES("gauntlets of typing", "brand-new gloves",
		0, 1, 0,			6, 1, 4,  50,  8, 0, LEATHER, HI_LEATHER),
GLOVES("gauntlets of swimming", "black gloves",
		0, 1,  SWIMMING,	6, 1, 10, 50,  9, 0, LEATHER, CLR_BLACK),
GLOVES("gauntlets of dexterity", "fencing gloves",
		0, 1,  0,			6, 1, 10, 50,  9, 0, LEATHER, HI_LEATHER),
GLOVES("gauntlets of reflection", "archery gloves",
		0, 1,  REFLECTING,  6, 1, 10, 50,  9, 0, SILVER, CLR_ORANGE),
...
BOOTS("speed boots", "combat boots",
		0, 1,  FAST,	  12, 2, 20, 50,  9, 0, LEATHER, CLR_BLACK),
/* With shuffled appearances... */
BOOTS("water walking boots", "jungle boots",
		0, 1,  WWALKING,  12, 2, 20, 50,  9, 0, LEATHER, CLR_ORANGE),
BOOTS("jumping boots", "hiking boots",
		0, 1,  JUMPING,   12, 2, 20, 50,  9, 0, LEATHER, CLR_GREEN),
BOOTS("elven boots", "mud boots",
		0, 1,  STEALTH,   12, 2, 15,  8,  9, 0, LEATHER, CLR_BROWN),
BOOTS("kicking boots", "steel boots",
		0, 1,  0,         12, 2, 15,  8,  9, 0, IRON, HI_SILVER),
BOOTS("fumble boots", "riding boots",
		0, 1,  FUMBLING,  12, 2, 20, 30,  9, 0, LEATHER, HI_LEATHER),
BOOTS("levitation boots", "snow boots",
		0, 1,  LEVITATION,12, 2, 15, 30,  9, 0, LEATHER, CLR_WHITE),
...
RING("gain constitution", 0,   "opal",      150, 1, 1, 5, MINERAL,  HI_MINERAL),
RING("gain dexterity",  0,     "obsidian",  150, 1, 1, 5, GEMSTONE, CLR_BLACK),
RING("gain intelligence", 0,   "plain",     150, 1, 1, 5, MINERAL,  HI_MINERAL),
RING("gain strength", 0,       "granite",   150, 1, 1, 5, MINERAL, HI_MINERAL),
RING("gain wisdom",     0,     "glass",     150, 1, 1, 5, MINERAL,  CLR_CYAN),
RING("health",		0,	"chrysoberyl",		200, 1, 1, 5, MINERAL,  CLR_CYAN),
RING("timely backup",	0,  "rusty",		300, 1, 1, 5, IRON,		CLR_BROWN),
...
/* Containers */
CONTAINER("large box", (char *)0,       1, 0, 0, 1,  30,350,   8, WOOD, HI_WOOD),
CONTAINER("chest", (char *)0,           1, 0, 0, 1,  30,600,  16, WOOD, HI_WOOD),
CONTAINER("ice box", (char *)0,         1, 0, 0, 1,  17,900,  42, PLASTIC, CLR_WHITE),/* and upped this from 15*/
CONTAINER("sack", "bag",                0, 0, 0, 0,  12, 15,  18, CLOTH, HI_CLOTH),
CONTAINER("ugly backpack", "bag",       0, 0, 0, 0,  12, 15,   2, CLOTH, CLR_BLUE),
CONTAINER("oilskin sack", "bag",        0, 0, 0, 0,  12, 15, 100, CLOTH, HI_CLOTH),/*
CONTAINER("bag of digestion","bag",		0, 1, 0, 0,  10,  5, 100, CLOTH, HI_CLOTH),maybe this is the problem with makemon?*/
CONTAINER("bag of holding", "bag",      0, 1, 0, 0,  18, 15, 100, CLOTH, HI_CLOTH),
CONTAINER("bag of tricks", "bag",       0, 1, 1, 0,  11, 15, 100, CLOTH, HI_CLOTH),
CONTAINER("trick bag", "bag",           0, 1, 1, 0,  11, 15, 100, CLOTH, HI_CLOTH),/* upped from 10, 12s up from 10 too*/
...
TOOL("tallow candle", "candle", 0, 1, 0, 0,  50,  2,  40, WAX, CLR_WHITE),
TOOL("wax candle", "candle",    0, 1, 0, 0,  40,  2,  80, WAX, CLR_WHITE),
TOOL("magic candle",  "candle", 0, 1, 1, 0,   8,  2, 500, WAX, CLR_WHITE),
TOOL("oil lamp", "lamp",        0, 0, 0, 0,  25, 20, 250, COPPER, CLR_YELLOW),
TOOL("brass lantern", (char *)0,1, 0, 0, 0,  15, 30, 150, COPPER, CLR_YELLOW),
...
#ifdef BARD
TOOL("syrinx", "reed flute",   0, 0, 0, 0,   0, 10,  30, WOOD, HI_WOOD),
#endif
TOOL("tooled horn", "horn",     0, 0, 0, 0,   2, 18,  50, BONE, CLR_WHITE),
...
TOOL("wooden harp", "harp",     0, 0, 0, 0,   2, 25,  50, WOOD, HI_WOOD),/*
TOOL("guitar", "guitar",        0, 0, 0, 0,   2, 10, 100, WOOD, CLR_BRIGHT_MAGENTA),/*purple rain? or purple haze? temp took it down to weptool and then put it back because I don't know the bits*/
TOOL("magic harp", "harp",      0, 0, 1, 1,   2, 23,  50, WOOD, HI_WOOD),
TOOL("bell", (char *)0,         1, 0, 0, 0,   2, 25,  50, COPPER, HI_COPPER),
...
/* Traps */
TOOL("land mine",(char *)0,     1, 0, 0, 0,   1,200, 180, IRON, CLR_RED),
TOOL("beartrap", (char *)0,     1, 0, 0, 0,   1,150,  60, IRON, HI_METAL),
TOOL("portable hole", (char *)0,
								1, 0, 0, 0,   1,150,  60, IRON, CLR_BLACK),
...
TEMP so I can see it all:
#define WEPTOOL(name,desc,kn,mgc,chg,bi,prob,wt,cost,sdam,ldam,hitbon,typ,sub,mat,clr) \
	OBJECT( OBJ(name,desc), \
		BITS(kn,0,1,chg,mgc,1,0,0,bi,0,typ,sub,mat), \
		0, TOOL_CLASS, prob, 0, \
		wt, cost, sdam, ldam, hitbon, 0, wt, clr )
WEPTOOL("guitar", "guitar", 0, 0, 0, 0,   1, 10, 100, WHACK, P_CLUB, WOOD, CLR_BRIGHT_MAGENTA),purple rain? or purple haze? needs more stuff to make it work > 3 items are missing between 4 zeros and 1, 10, 100*/
/* 3.4.1: unicorn horn left classified as "magic" */
WEPTOOL("unicorn horn", (char *)0,
	1, 1, 0, 1,  0,  20, 100, 12, 12, 0, PIERCE, P_UNICORN_HORN, BONE, CLR_WHITE),
WEPTOOL("guitar", (char *)0,
	1, 1, 0, 1,  18, 40,  40, 15, 15, 0, WHACK, P_CLUB, WOOD, CLR_BRIGHT_MAGENTA/*, 15 extraneous?*/),
...
WEPTOOL("green lightsaber", "lightsaber",
	0, 0, 1, 0,  1, 60, 500, 3,  5, -3, SLASH, P_LIGHTSABER, PLASTIC, CLR_GREEN),
# ifdef D_SABER
WEPTOOL("blue lightsaber",  "lightsaber",
	0, 0, 1, 0,  1, 60, 500, 5,  7, -3, SLASH, P_LIGHTSABER, PLATINUM, CLR_BLUE),
# endif /* D_SABER */
WEPTOOL("red lightsaber",  "lightsaber",
	0, 0, 1, 0,  1, 60, 500, 9,  11, -3, SLASH, P_LIGHTSABER, PLATINUM, CLR_RED),
WEPTOOL("red double lightsaber",  "double lightsaber",
	0, 0, 1, 1,  0, 60,1000, 9,  11, -4, SLASH, P_LIGHTSABER, PLATINUM, CLR_ORANGE),
# ifdef D_SABER
#if 0 // just an idea...
WEPTOOL("yellow lightsaber",  "lightsaber",
	0, 0, 1, 0,  0, 60, 500, 5,  7, -3, SLASH, P_LIGHTSABER, PLATINUM, CLR_YELLOW),
WEPTOOL("violet lightsaber",  "lightsaber",
	0, 0, 1, 0,  0, 60, 500, 5,  7, -3, SLASH, P_LIGHTSABER, PLATINUM, CLR_MAGENTA),
WEPTOOL("white lightsaber",  "lightsaber",
	0, 0, 1, 0,  0, 60, 500, 5,  7, -3, SLASH, P_LIGHTSABER, PLATINUM, CLR_WHITE),
# endif /* D_SABER */
#endif
#endif	/* LIGHTSABERS */
...
TOOL("expensive camera", (char *)0,
				1, 0, 0, 1,  12, 12, 200, PLASTIC, CLR_BLACK),
...
TOOL("crystal ball", "glass orb",
								0, 0, 1, 1,  11,150,  60, GLASS, HI_GLASS),
/*#if 0 added back just for fun*/
/* STEPHEN WHITE'S NEW CODE */
/* KMH -- removed because there's potential for abuse */
TOOL("orb of enchantment", "glass orb",
				0, 0, 1, 1,   1, 75, 750, GLASS, HI_GLASS),
TOOL("orb of charging", "glass orb",
				0, 0, 1, 1,   1, 75, 750, GLASS, HI_GLASS),
TOOL("orb of destruction", "glass orb",
				0, 0, 0, 0,   1, 75, 750, GLASS, HI_GLASS),
/*#endif*/
TOOL("lenses", (char *)0,	1, 0, 0, 0,   5,  3,  80, GLASS, HI_GLASS),
TOOL("blindfold", (char *)0,    1, 0, 0, 0,  35,  2,  20, CLOTH, CLR_BLACK),
TOOL("towel", (char *)0,        1, 0, 0, 0,  35,  2,  50, CLOTH, CLR_MAGENTA),
#ifdef STEED
...
#endif
TOOL("stethoscope", (char *)0,  1, 0, 0, 0,  15,  4,  75, IRON, HI_METAL),
TOOL("tinning kit", (char *)0,  1, 0, 0, 1,  15, 75,  30, IRON, HI_METAL),
TOOL("upgrade kit", (char *)0,  1, 0, 0, 0,  15,100,  30, COPPER, HI_COPPER),
CONTAINER("medical kit", "leather bag",
				0, 0, 0, 0,  10, 25, 500, LEATHER, HI_LEATHER),
TOOL("tin opener", (char *)0,   1, 0, 0, 0,  10,  4,  30, IRON, HI_METAL),
TOOL("can of grease", (char *)0,1, 0, 0, 1,  10, 15,  20, IRON, HI_METAL),
TOOL("figurine", (char *)0,     1, 0, 1, 0,  15, 50,  80, MINERAL, HI_MINERAL),
...
FOOD("pear",                 7, 1,  2, 0, VEGGY,  50, CLR_GREEN),
FOOD("asian pear",           1, 1,  2, 0, VEGGY,  75, CLR_BRIGHT_GREEN),
FOOD("banana",              7, 1,  2, 0, VEGGY,  75, CLR_YELLOW),
FOOD("orange",              7, 1,  2, 0, VEGGY,  75, CLR_ORANGE),
FOOD("tomato",              7, 1,  2, 0, VEGGY,  75, CLR_RED),
FOOD("mushroom",             1, 1,  5, 0, VEGGY,  75, CLR_BLACK),
FOOD("melon",                7, 1,  5, 0, VEGGY,  75, CLR_BRIGHT_GREEN),
FOOD("slime mold",          68, 1,  5, 0, VEGGY, 225, CLR_ORANGE),
FOOD("slice of pizza",       4, 1,  0, 0, VEGGY, 400, CLR_ORANGE),
FOOD("peanut bag",	     10, 3,  0, 0, VEGGY, 800, HI_ORGANIC),
...
FOOD("food ration",        360, 5, 20, 0, VEGGY, 800, HI_ORGANIC),
FOOD("Hacker's Food",	    20, 1, 0, 0, VEGGY, 800, HI_METAL),
...
POTION("levitation", "cyan",            1, LEVITATION, 34, 200, CLR_CYAN),
...
POTION("paralysis", "emerald",          1, 0,          36, 300, CLR_BRIGHT_GREEN),
...
POTION("amnesia", "sparkling",          1, 0,          15, 100, CLR_CYAN),
...
/* Attack */
SCROLL("create monster",        "LEP GEX VEN ZEA",      P_ATTACK_SPELL, 1,  45, 200, CLR_RED),
SCROLL("leet hax",              "LEET 1337",            P_ATTACK_SPELL, 1,   2, 300, CLR_CYAN),
/* Enchantment */
SCROLL("taming",                "PRIRUTSENIE",          P_ENCHANTMENT_SPELL, 1,  15, 200, CLR_YELLOW),
/* Divination */
SCROLL("light",                 "VERR YED HORRE",       P_DIVINATION_SPELL, 1,  80,  50, CLR_ORANGE),
SCROLL("food detection",        "YUM YUM",              P_DIVINATION_SPELL, 1,  28, 100, CLR_GREEN),
SCROLL("gold detection",        "THARR",                P_DIVINATION_SPELL, 1,  28, 100, CLR_BRIGHT_GREEN),
SCROLL("identify",              "KERNOD WEL",           P_DIVINATION_SPELL, 1, 180,  20, CLR_YELLOW),
SCROLL("magic mapping",         "ELAM EBOW",            P_DIVINATION_SPELL, 1,  40, 100, CLR_BRIGHT_BLUE),
/* Enchantment */
SCROLL("confuse monster",       "NR 9",                 P_ENCHANTMENT_SPELL,  1,  40, 100, CLR_MAGENTA),
SCROLL("scare monster",         "XIXAXA XOXAXA XUXAXA", P_ENCHANTMENT_SPELL,  1,  30, 100, CLR_BRIGHT_MAGENTA),
SCROLL("enchant weapon",        "DAIYEN FOOELS",        P_ENCHANTMENT_SPELL,  1,  75,  60, CLR_GRAY),
SCROLL("enchant armor",         "ZELGO MER",            P_ENCHANTMENT_SPELL,  1,  65,  80, CLR_BRIGHT_CYAN),
/* Protection */
SCROLL("remove curse",          "PRATYAVAYAH",          P_PROTECTION_SPELL, 1,  65,  80, CLR_BLACK),
/* Body */
SCROLL("teleportation",         "VENZAR BORGAVVE",      P_BODY_SPELL, 1,  54, 90, CLR_ORANGE),
/* Matter */
SCROLL("fire",                  "ANDOVA BEGARIN",       P_MATTER_SPELL, 1,  20, 100, CLR_RED),
SCROLL("earth",                 "KIRJE",                P_MATTER_SPELL, 1,  20, 200, CLR_CYAN),
SCROLL("flood",                 "DOLOF",                P_MATTER_SPELL, 1,  20, 200, CLR_BLUE),

SCROLL("destroy armor",         "JUYED AWK YACC",       P_NONE, 1,  45, 100, CLR_GREEN),
SCROLL("amnesia",               "DUAM XNAHT",           P_NONE, 1,  25, 200, CLR_BRIGHT_GREEN),
SCROLL("charging",              "HACKEM MUCHE",         P_NONE, 1,  15, 300, CLR_BLUE),
SCROLL("genocide",              "ELBIB YLOH",           P_NONE, 1,  15, 300, CLR_BRIGHT_BLUE),
SCROLL("punishment",            "VE FORBRYDERNE",       P_NONE, 1,  15, 300, CLR_MAGENTA),
SCROLL("stinking cloud",	    "VELOX NEB",            P_NONE, 1,  15, 300, CLR_BRIGHT_MAGENTA),
SCROLL("mass murder",		"ENEMATZU MEMALEZU",	P_NONE,  1,   5, 300, CLR_YELLOW),
SCROLL("undo genocide",		"42",			      P_NONE,  1,  5, 300, CLR_BRIGHT_CYAN),
SCROLL("reverse identify",	"OH CAPTAIN MY CAPTAIN",P_NONE,  1,  18, 300, CLR_BLUE),
SCROLL("wishing",		"TRICK 13",		      P_NONE,  1,  2, 300, CLR_ORANGE),
SCROLL("consecration",		"MAY THE FORCE BE WITH YOU",
								      P_NONE,  1,  5, 300, CLR_BRIGHT_GREEN),
SCROLL("root password detection","XYZZY",		      P_NONE,  1,  0, 1000, CLR_BRIGHT_BLUE),
SCROLL((char *)0,		        "FOOBIE BLETCH",        P_NONE, 1,   0, 100, CLR_BRIGHT_CYAN),
SCROLL((char *)0,		        "TEMOV",                P_NONE, 1,   0, 100, CLR_BLACK),
SCROLL((char *)0,		        "GARVEN DEH",           P_NONE, 1,   0, 100, CLR_ORANGE),
SCROLL((char *)0,		        "READ ME",              P_NONE, 1,   0, 100, CLR_GRAY),
/* these must come last because they have special descriptions */
#ifdef MAIL
SCROLL("mail",                  "stamped",              P_NONE, 0,   0,   0, CLR_WHITE),
#endif
SCROLL("blank paper",           "unlabeled",            P_NONE, 0,  28,  60, CLR_WHITE),
#undef SCROLL
...
SPELL("healing",         "white",       P_HEALING_SPELL, 25,  2, 1, 1, IMMEDIATE, CLR_BRIGHT_MAGENTA),
...
SPELL("create familiar", "glittering",  P_HEALING_SPELL, 10,  7, 6, 1, NODIR,     CLR_YELLOW),
/* Divination spells */
...
/* Protection spells */
SPELL("protection",      "wide",        P_PROTECTION_SPELL,  5,  3, 1, 1, NODIR,     CLR_BRIGHT_BLUE),
...
/* Matter spells */
SPELL("knock",           "pink",        P_MATTER_SPELL, 20,  1, 1, 1, IMMEDIATE, CLR_BRIGHT_MAGENTA),
...
SPELL("gas sphere",      "moldy",       P_MATTER_SPELL, 10,  2, 2, 1, NODIR, CLR_BROWN),
SPELL("shock sphere",    "patchwork",   P_MATTER_SPELL, 10,  2, 2, 1, NODIR, HI_PAPER),
SPELL("slumber sphere",  "hazy",        P_MATTER_SPELL, 10,  2, 1, 1, NODIR, CLR_ORANGE),
SPELL("confusing sphere","deep black",  P_MATTER_SPELL, 10,  2, 2, 1, NODIR, CLR_BLACK),
SPELL("poison sphere",   "acid green",  P_MATTER_SPELL, 10,  2, 3, 1, NODIR, CLR_GREEN),
SPELL("void sphere",     "damaged",     P_MATTER_SPELL,  5,  2, 3, 1, NODIR, CLR_BLACK),
...
SPELL("magic missile",   "vellum",      P_ATTACK_SPELL, 30,  3, 2, 1, RAY,       HI_PAPER),
SPELL("fireball",        "ragged",      P_MATTER_SPELL, 10,  6, 4, 1, RAY,       HI_PAPER),
SPELL("cone of cold",    "dog eared",   P_MATTER_SPELL, 10,  8, 5, 1, RAY,       HI_PAPER),
...
WAND("digging",        "iron",     45, 150, 1, RAY,       IRON,     CLR_ORANGE),
WAND("magic missile",  "steel",    45, 150, 1, RAY,       IRON,     CLR_BLUE),
WAND("fire",           "hexagonal",25, 175, 1, RAY,       IRON,     HI_SILVER),
WAND("cold",           "short",    25, 175, 1, RAY,       IRON,     CLR_BRIGHT_BLUE),

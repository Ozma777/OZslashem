...
/* check if a monster could pick up objects from a location *//* kludged up is_puddle so it will work but didn't*/
STATIC_OVL boolean
...
xchar nx, ny;
{
	...
	(!is_puddle(nx,ny) || likes_lava(mon->data)) && doesn't work of course*/

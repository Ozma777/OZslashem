...
static const struct innate_tech 
	...
	gee_tech[] = { {   1, T_RESEARCH, 1},
		       {   9, T_REINFORCE, 1},
			   {  15, T_PRACTICE, 1},
		       {  23, T_SIGIL_DISCHARGE, 1},
		       {   0, 0, 0} },
	gan_tech[] = { {   5, T_PUMMEL, 1},/*not yet
		       {   8, T_CREATE_AMMO, 1},*/
			   {  15, T_VANISH, 1},
			   {   0, 0, 0} },
	hea_tech[] = { {   1, T_SURGERY, 1},
		       {  20, T_REVIVE, 1},
		       {   0, 0, 0} },
	ins_tech[] = { {   5, T_DRAW_ENERGY, 1},
					{   9, T_HEAL_HANDS, 1},
					{   13, T_RESEARCH, 1},
					{   23, T_SIGIL_TEMPEST, 1},
		       {   0, 0, 0} },
	...
	mon_tech[] = { {   1, T_PUMMEL, 1},
		       ...
		       {  20, T_POWER_SURGE, 1},
		       {   0, 0, 0} },
	met_tech[] = { {   1, T_REINFORCE, 1},
		       {   5, T_DRAW_ENERGY, 1},
                       {  10, T_POWER_SURGE, 1},
                       {  12, T_SIGIL_TEMPEST, 1},
                       {  20, T_SIGIL_DISCHARGE, 1},
		       {   0, 0, 0} },
	...
	pri_tech[] = { {   1, T_TURN_UNDEAD, 1},
		       ...
		       {   0, 0, 0} },
#ifdef PIRATE
    pir_tech[] = { {   1, T_CRIT_STRIKE, 1},
               {   1, T_BERSERK, 1},
               {   8, T_DRAW_ENERGY, 1},
               {  13, T_POWER_SURGE, 1},
               {  15, T_CUTTHROAT, 1},
               {  17, T_SIGIL_TEMPEST, 1},
               {   0, 0, 0} },
#endif	
	...
	gno_tech[] = { {   1, T_VANISH, 1},
		       {   7, T_TINKER, 1},
		       {   0, 0, 0} },
	gia_tech[] = { {   1, T_PUMMEL, 1},
		       {   0, 0, 0} },
	hob_tech[] = { {   1, T_BLINK, 1},
		       {   0, 0, 0} },
	kob_tech[] = { {   1, T_BLINK, 1},
			   {   1, T_VANISH, 1},
		       {   0, 0, 0} },
	lyc_tech[] = { {   1, T_EVISCERATE, 1},
		       {  10, T_BERSERK, 1},
		       {   0, 0, 0} },
	syl_tech[] = { {   1, T_DRAW_ENERGY, 1},
			   {   1, T_HEAL_HANDS, 1},
			   {   8, T_DAZZLE, 1},
		       {   0, 0, 0} },
	tro_tech[] = { {   1, T_RAGE, 1},
	...
	ung_tech[] = { {   1, T_TINKER, 1},
		       ...
		       {   1, T_SURGERY, 1},
		       {   0, 0, 0} },
	vee_tech[] = { {   1, T_DAZZLE, 1},
		       {   1, T_DRAW_ENERGY, 1},
		       {   0, 0, 0} },
	vam_tech[] = { {   1, T_DAZZLE, 1},
		       {   1, T_DRAW_BLOOD, 1},
		       {   0, 0, 0} },
	yak_tech[] = { {   1, T_CRIT_STRIKE, 1},
				{   1, T_DASH, 1},
				{   8, T_CHI_HEALING, 1},
				{  10, T_CHI_STRIKE, 1},
				{  11, T_KIII, 1},
...
int tech_no;
{
	...
	return(1);
}/* need to COMPLETELY redo this if I am going to use it for gangster....doom marine might be cool too
case T_CREATE_AMMO:
...
role_tech()
{
	switch (Role_switch) {
		...
		case PM_AETHERIC_MAGE:	return (aet_tech);
		case PM_BARBARIAN:	return (bar_tech);
		case PM_BARD:	return (brd_tech);
		case PM_CAVEMAN:	return (cav_tech);
#ifdef CONVICT
		case PM_CONVICT:	return (con_tech);
#endif
		case PM_EXPLORATOR:	return (exp_tech);
		case PM_EARTH_MAGE:	return (ear_tech);
		...
		case PM_INSTRUMENTALIST:	return (ins_tech);
		...
		case PM_METAL_MAGE:	return (met_tech);

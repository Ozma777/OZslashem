...
#define ARMORY          17      /* weapons, armor and rust monsters (L) */
#define ANTHOLE         18      /* ants! */
#define LEMUREPIT       19      /* lemures */
#define MIGOHIVE        20      /* Mi-Go */
#define FUNGUSFARM      21      /* molds, puddings, and slime */
#define GARDEN          22      /* nymphs, trees and fountains */
#define DOUGROOM	23	/* Adams, creeping 42's etc. */

...
#endif /* CONVICT can get luckblade but it also should be NON_PM (slashTHEM artifact)*/
...
A("Serpent's Tongue",            DAGGER,
	SPFX_RESTR, 0, 0,
        PHYS(2,0),      NO_DFNS,        NO_CARY,        0, A_CHAOTIC, NON_PM, NON_PM, 400L ),
...
A("Wand Of Might",		WAN_WISHING,
 	(SPFX_RESTR|SPFX_TOUCH), 0,	0,
 	NO_ATTK,	NO_DFNS,	NO_CARY,
...
A("Shock Blade",                ATHAME,
	(SPFX_RESTR|SPFX_ATTK|SPFX_DEFN), 0, 0,
        ELEC(5,5),      ELEC(0,0),      NO_CARY,        0, A_CHAOTIC, PM_METAL_MAGE, NON_PM, 400L ),

A("Storm Brand",                TWO_HANDED_SWORD,
	(SPFX_RESTR|SPFX_ATTK|SPFX_DEFN), 0, 0,
        ELEC(5,0),      ELEC(0,0),      NO_CARY,        0, A_NONE, PM_METAL_MAGE, NON_PM, 3000L ),
		
A("Blunderbuss",                RIFLE,
	(SPFX_RESTR|SPFX_ATTK), (SPFX_ESP|SPFX_EREGEN), 0,
		STUN(8,13),     NO_DFNS,        NO_CARY,        0, A_CHAOTIC, PM_AETHERIC_MAGE, NON_PM, 16000L ),

A("Tooth of Shai-hulud",	CRYSKNIFE,
        (SPFX_RESTR|SPFX_INTEL|SPFX_SCLAIR|SPFX_WARN), 0, 0,
        PHYS(2,4),      NO_DFNS,        NO_CARY,
...
A("The Air Crystal",	MAGIC_BOOMERANG,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL|SPFX_XRAY),
		(SPFX_STLTH|SPFX_SEARCH|SPFX_WARN), 0,
	PHYS(5,10),	NO_DFNS,	CARY(AD_ELEC),
	SUMMON_AIR_ELEMENTAL,	A_NEUTRAL,	 PM_AETHERIC_MAGE, NON_PM, 50000L ),
...
/* STEPHEN WHITE'S NEW CODE AND ALSO NEW FROM ME*//*change seek to speed once I have coded it into artifact.h */
A("The Staff of Speed Walking",	QUARTERSTAFF,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_ATTK|SPFX_INTEL|SPFX_SEEK|SPFX_REGEN|SPFX_HPHDAM), 0,0,
	STUN(8,13),      NO_DFNS,        CARY(AD_MAGM),
	HEALING,	A_LAWFUL, PM_EXPLORATOR, NON_PM, 50000L ),

A("Drum of the Stone Warrior",        DRUM_OF_EARTHQUAKE,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL),
		(SPFX_ESP|SPFX_REGEN|SPFX_HSPDAM), 0,
	NO_ATTK,        NO_DFNS,        CARY(AD_MAGM),
	SUMMON_EARTH_ELEMENTAL,         A_NEUTRAL, PM_EARTH_MAGE, NON_PM, 50000L ),

A("The Shakruum of Power",	MAGIC_BOOMERANG,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_ATTK|SPFX_INTEL),
		(SPFX_STLTH|SPFX_SEARCH|SPFX_WARN|SPFX_HSPDAM|SPFX_HPHDAM), 0,
	STUN(5,10),	NO_DFNS,	CARY(AD_MAGM),
	TAMING,	A_LAWFUL,	 PM_FIGHTER, NON_PM, 50000L ),
...
A("The Lyre of Orpheus",       WOODEN_HARP,
        ...
        NO_ATTK,        NO_DFNS,        CARY(AD_MAGM),
        IDENTIFY,       A_NEUTRAL, PM_BARD, NON_PM, 5000L ),
#endif
...
A("The Guitar Of All Worlds",       GUITAR,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_ATTK|SPFX_INTEL), (SPFX_WARN|SPFX_TCTRL), 0,
	STUN(8,14),      NO_DFNS,        CARY(AD_MAGM),
	ENERGY_BOOST,   A_NEUTRAL, PM_INSTRUMENTALIST, NON_PM, 50000L ),
...
/* STEPHEN WHITE'S NEW CODE and mine and others too*/
A("The Staff of Ancient Ice",	QUARTERSTAFF,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_ATTK|SPFX_DEFN|SPFX_INTEL|SPFX_TCTRL|SPFX_REGEN|SPFX_HPHDAM), 0,0,
	COLD(8,13),      FIRE(0,0),        CARY(AD_MAGM),
	HEALING,	A_NEUTRAL, PM_ICE_MAGE, NON_PM, 5000L ),
...
A("Charged USB stick", INSECT_SQUASHER,
	...
	NO_ATTK,        NO_DFNS,  CARY(AD_ELEC),        CHARGE_OBJ, A_NEUTRAL, PM_WANDKEEPER, NON_PM, 3000L ),	
...
A("The Storm Whistle",          MAGIC_WHISTLE,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL), (SPFX_WARN|SPFX_TCTRL), 0,
	NO_ATTK,        NO_DFNS,        CARY(AD_DISE),
	SUMMON_LIGHTNING_ELEMENTAL,         A_LAWFUL, PM_METAL_MAGE, NON_PM, 50000L ),
...
A("The Marauders Map", SCR_MAGIC_MAPPING,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL), (SPFX_ESP|SPFX_SEARCH), 0,
	NO_ATTK,        NO_DFNS,        CARY(AD_MAGM),
	OBJ_DETECTION,     A_CHAOTIC, PM_PIRATE, NON_PM, 2000L ),

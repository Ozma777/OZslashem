...
#define is_troll(ptr)		(((ptr)->mflags2 & M2_TROLL) != 0L)
#define is_sylph(ptr)		(((ptr)->mflags2 & M2_SYLPH) != 0L)
#define is_ogre(ptr)		(((ptr)->mflags2 & M2_OGRE) != 0L)
#define is_kobold(ptr)		(((ptr)->mflags2 & M2_KOBOLD) != 0L)
#define is_ratling(ptr)		(((ptr)->mflags2 & M2_RATLING) != 0L)
#define is_drakeling(ptr)		(((ptr)->mflags2 & M2_DRAKELING) != 0L)
#define is_illithid(ptr)		(((ptr)->mflags2 & M2_ILLITHID) != 0L)
...
#define nonliving(ptr)		(is_golem(ptr) || is_undead(ptr) || is_clockwork(ptr) || \
				 (ptr)->mlet == S_VORTEX || \
				 (ptr) == &mons[PM_MANES])

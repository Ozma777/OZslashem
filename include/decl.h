...
#define STARTQ_ROLE	'r'
#define STARTQ_RACE	'c'
#define STARTQ_GENDER 'g'
#define STARTQ_ALIGN 'a'
#define NUM_STARTQ	4

E const char startq_chars[NUM_STARTQ];
E char startq_order[NUM_STARTQ];
...
E NEARDATA char bluedragonname[];
E NEARDATA char yellowdragonname[];
#endif

...
#define OATTACHED_UNUSED3 3
	...
	Bitfield(bypass,1);	/* mark this as an object to be skipped by bhito() *//*commented out extra dnethack things in case of later
	...
	Bitfield(was_thrown,1); /* thrown by the hero since last picked up *//*not present in Amy's but in dNethack
...
#define Is_container(o) ((o)->otyp == MEDICAL_KIT || \
			             (o)->otyp >= LARGE_BOX && (o)->otyp <= TRICK_BAG)
...
/* misc *//*stop maybe I need .oc_material instead? converted straight across to oc_material changing others too*/
#ifdef KOPS

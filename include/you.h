...
#define MATTK_CLOCK 1
#define MATTK_DARK 2/* had to put at least clock in so that you could adjust clock speed but dark will eventually be used for mist elf*/

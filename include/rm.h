...
#define TRWALL		11
#define DBWALL		12
#define IRONBARS		13	/* Added by KMH */
#define TREE		14	/* Added by KMH */
#define SDOOR		15
#define SCORR		16
#define POOL		17
...
#define IS_COLUMN(typ)	((typ) == COLUMN)
...
#define S_column	18	/* L */
#define S_tree		19	/* Added by KMH */
#define S_room		20
#define S_corr		21
#define S_litcorr	22
#define S_upstair	23
...
#define MAXPCHARS	S_explode9 + 1	/* maximum number of mapped characters */
#define MAXDCHARS	S_water + 1	/* maximum of mapped dungeon characters */
#define MAXTCHARS	(S_polymorph_trap - S_arrow_trap) + 1 /* maximum of mapped trap characters */
#define MAXECHARS	(S_vbeam - S_sw_br) + 1 /* maximum of mapped effects characters */
#define MAXEXPCHARS	(S_explode9 - S_explode1) + 1 /* number of explosion characters */
...
/*
 * Breaking columns should have the same odds of causing a collapse
 * in every situation.
 * (Maybe it should be dependant on dungeon depth?)
 */

#define column_collapse	rn2(2)

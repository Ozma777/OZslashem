...
#define SPFX_SCLAIR 0x8000000L /* super-clairvoyance - clair+detect unseen */
#define SPFX_PROTEC 0x8400000L	/* protects you if worn (+2 to AC) */
#define SPFX_TOUCH  0x8800000	/* artifact doesn't care if touched */
...
#define SUMMON_UNDEAD   (LAST_PROP+11)
#define DEATH_GAZE      (LAST_PROP+12)
#define LIGHT_AREA      (LAST_PROP+13) /* STEPHEN WHITE'S NEW CODE */
#define PROT_POLY       (LAST_PROP+14)
#define SUMMON_FIRE_ELEMENTAL           (LAST_PROP+15)
#define SUMMON_WATER_ELEMENTAL          (LAST_PROP+16)
#define SUMMON_AIR_ELEMENTAL           (LAST_PROP+17)
#define SUMMON_LIGHTNING_ELEMENTAL          (LAST_PROP+18)
#define SUMMON_EARTH_ELEMENTAL          (LAST_PROP+19)
#define OBJ_DETECTION	(LAST_PROP+20)
#define IDENTIFY        (LAST_PROP+21)
#define DRAGON_BREATH	(LAST_PROP+22)

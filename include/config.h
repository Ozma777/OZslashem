...
#define REINCARNATION   /* Special Rogue-like levels, I love this level so I put it back in*/
...
#define BARD        /* Bards and Songs - ABA */
...
#define OTHER_SERVICES  /* shopkeeper services including wind clockwork commented out for later*/
...
#define DUNGEON_GROWTH /* two of these? oops....I'll keep it for now but figure out which one was first*/

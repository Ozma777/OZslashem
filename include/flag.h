...
#define discover flags.explore
	...
	boolean  towelday;	/* it's Douglas Adams' Birthday */
	boolean  creatorday;	/* it's My Birthday */
...
/*WAC keep_save option*/
	...
	boolean  cth_attk;		/ for use with stinking cloud, took it out*/
	boolean  move;
	boolean  mv;

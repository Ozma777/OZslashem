...
#define AD_DEPR		42		/* depression --- random bad effect */
#define AD_ENCH		43	/* KMH -- remove enchantment */
#define AD_POLY		44	/* RJ -- polymorphs (genetic engineer) */
#define AD_CORR		45	/* corrode armor (black pudding) */
#define AD_TCKL		46	/* Tickle (Nightgaunts) */
#define AD_DARK		47	/* acts similar to cursed scroll of light, making an area unlit *//*
#define AD_FEAR		48	/* causes fear removing the commented out AD_FEAR so gaze attack 47 program in disarray goes away It won't grues are AD_DARK*/

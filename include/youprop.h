...
#define Sleeping		(HSleeping || ESleeping || Race_if(PM_KOBOLD))
...
#define HSeeking		u.uprops[SEEKING].intrinsic
#define ESeeking		u.uprops[SEEKING].extrinsic
#define Seeking		    (HSeeking || ESeeking)
...
#define Polymorph		(HPolymorph || EPolymorph || Race_if(PM_UNGENOMOLD))
...
#define Polymorph_control	((HPolymorph_control || EPolymorph_control) && !NoPolymorph_control && !Race_if(PM_UNGENOMOLD))

#define HUnchanging		u.uprops[UNCHANGING].intrinsic
#define EUnchanging		u.uprops[UNCHANGING].extrinsic
#define Unchanging		((HUnchanging || EUnchanging) && !Race_if(PM_UNGENOMOLD))	/* KMH */
